...
if (isset($_SESSION["validar"])) {   
    ...
    if($_SESSION["rol"]==1){//administrador
        ...
        echo '<ul><li><a href="#">Vista de profesor</a></li>
              ...
              <li  id="calendario" class="menu"><a href="index.php?action=calendario">Calendario</a></li>
              <li class="menu"><a href="index.php?action=practicasAlumnos">Descargar prácticas de alumnos</a></li>
              <ul>';
        ...
        <li class="menu"><a href="index.php?action=practicas">Ver practicas</a></li>
        <li class="menu"><a href="index.php?action=entregar">Entregar Prácticas</a></li>
