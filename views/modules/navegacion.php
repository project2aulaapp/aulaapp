...
if (isset($_SESSION["validar"])) {   
    ...
    if($_SESSION["rol"]==1){//administrador
        echo '<ul class="menu__list">
                ...
                <li  id="perfil" class="menu__item"><a class="menu__link" href="index.php?action=perfil">Perfil</a></li>
        ...
        echo '<ul class="menu__list">
              ...
              <li  id="asignaturasProfe" class="menu__item"><a class="menu__link" href="index.php?action=asignaturasProfesor">Asignaturas</a></li>
        ...
        echo '<ul class="menu__list">
                <li class="menu__item"><a class="menu__link" href="index.php?action=asignaturas">Asignaturas</a></li>
                ...
                <li class="menu__item"><a class="menu__link" href="index.php?action=perfil">Perfil</a></li>
